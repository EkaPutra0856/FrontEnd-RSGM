...
import { RegistrationForm } from "@/component/penelitian/daftar-penelitian-magang/pengajuan-penelitian/registration-form"
    ...
    return (
        <div className="flex flex-col min-h-screen">
            ...
            <div className="flex flex-1 flex-col md:flex-row">
                <SidebarPenelitian className="w-full md:w-1/4" />
